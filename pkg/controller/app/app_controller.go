...
import (
	...
	appsv1beta1 "github.com/caarlos0/apps-operator/pkg/apis/apps/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appsv1beta1.App{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=apps.carlosbecker.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.carlosbecker.com,resources=apps/status,verbs=get;update;patch
func (r *ReconcileApp) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the App instance
	instance := &appsv1beta1.App{}
